...
import com.example.rxjava3demo.bus.RxBusActivity;
import com.example.rxjava3demo.net.OkhttpActivity;
import com.example.rxjava3demo.net.RetrofitActivity;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        bt_base = (Button) this.findViewById(R.id.bt_base);
